...
//
// Generated by tools/newport.py from PRIMARY_a410_100e.BIN; profile in
// profiles/a410-100e.json. The A410 is the closest sibling of the A460 the
...
// not because it was copied and hoped for.
    ...
    // strength of tools/newport.py's second-wave detectors, which found this
    ...
    // The three per-camera rows, reversed out of cameras/a410/ghidra/.
    //
    ...
    // NOT ported, and both blocked on a Ghidra session rather than on effort:
    //
    ...
    //
    // Date/time prompt suppression. Found by tools/newport.py, which anchors on
